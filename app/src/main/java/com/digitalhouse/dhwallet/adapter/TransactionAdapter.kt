...
class TransactionAdapter(
    ...
    private val detailsAction: (GroupTransaction) -> Unit
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            HEADER -> TransactionHeaderViewHolder(
                inflater.inflate(
            ...
            DATA -> TransactionDataViewHolder(
                inflater.inflate(
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return when(item[position].type){
            GroupTypeTransaction.HEADER -> HEADER
            GroupTypeTransaction.DATA -> DATA
            else -> CONTENT
        }
...
class TransactionHeaderViewHolder(view: View, detailsAction: (GroupTransaction) -> Unit) :
    ...
    init {
        view.setOnClickListener {
            currentContent?.let { transaction ->
                detailsAction.invoke(transaction)
            }
        }
    }
...
class TransactionViewHolder(view: View, detailAction: (GroupTransaction) -> Unit) :
    RecyclerView.ViewHolder(view) {
